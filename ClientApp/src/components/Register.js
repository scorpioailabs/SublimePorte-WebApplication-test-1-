...
export class Register extends Component {
    ...
    constructor() {
        ...
        this.sublimeName = this.sublimeName.bind(this);
    ...
    sublimeName(event) {
        this.setState({ sublimeName: event.target.value })
    }
    UserName(event) {
    ...
    registerSubmit(event) {
        fetch('https://localhost:44302/accounts/register', {
            ...
            body: JSON.stringify({
                ...
                sublimeName: this.state.sublimeName,
        ...
        return (
            <div>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" onChange={this.sublimeName}  placeholder="Enter your sublime name!" />
                </div>
